...
function(c){d.stream=c;a()},function(c){c.code==c.PERMISSION_DENIED?a("User denied access to microphone, or the web browser did not allow microphone access at this address.",31208):a("Error occurred while accessing microphone.",31201)})},_setupPeerConnection:function(){var a=c.protocol;a.create();a.pc.addStream(this.stream);var d=this;a.pc.onaddstream=function(a){d.video.src=webkitURL.createObjectURL(a.stream)};a.createOffer({audio:!0});return a},_setupChannel:function(a,c,g,f,h,p){try{var u=e.WebSocket(a)}catch(w){this.onerror({info:w.message});
this.close();return}var r=this;u.onopen=function(){r.version.pc.onopen=r.onopen;r.version.pc.onstatechange=function(a){if(r.version.pc&&"stable"==r.version.pc.readyState)r.onopen()};r.version.pc.onsignalingstatechange=function(a){if(r.version.pc&&"stable"==r.version.pc.signalingState)r.onopen()};u.send(JSON.stringify({type:"OFFER",sdp:r.version.getSDP(),twilio:{appsid:c?d.objectize(c).iss:null,token:c,bridgeToken:g,params:f,extras:[h,p]}}))};u.onmessage=function(a){if("\n"==a.data)u.send("\n");else if(a=
JSON.parse(a.data),"ANSWER"===a.type)r.version.processAnswer(a.sdp);else if("CANDIDATE"===a.type)r.version.processCandidate(a.candidate,a.label);else if("HANGUP"===a.type){if(a.error)r.onerror({info:{code:a.error.code,message:a.error}});r.sendHangup=!1;r.close()}};u.onclose=function(){r.sock&&r.close()};return u},open:function(a,c,d,e,g,p){this.sock||(this.version=this._setupPeerConnection(),this.sock=this._setupChannel(a,c,d,e,g,p))},exec:function(a){var c=[].slice.call(arguments,1);if("sendDTMF"===
a){var d=c[0];d&&d.length&&this.sock&&this.sock.send(JSON.stringify({type:"DTMF",dtmf:c[0]}))}},close:function(){this.version.pc&&(this.version.pc.close(),this.version.pc=null);this.sock&&(this.sendHangup&&this.sock.send(JSON.stringify({type:"HANGUP"})),this.sock.close(),this.sock=null);this.stream&&(f(this.stream),this.stream=null);this.video.src="";this.onclose()},play:function(){},publish:function(){},attachAudio:function(){this.stream&&(("function"===typeof this.stream.getAudioTracks?this.stream.getAudioTracks():
...
"swfobject"),c="undefined"!=typeof navigator?navigator:{},c={p:"browser",v:"1.1",browser:{userAgent:c.userAgent||"unknown",platform:c.platform||"unknown"}};b.enabled()?c.plugin="rtc":(c.plugin="flash",c.flash={v:a.getFlashPlayerVersion()});return c}};t["lib/twilio.js"]=function(h,a){a.Device=h("twilio/device").Device;a.EventStream=h("twilio/eventstream").EventStream;a.Connection=h("twilio/connection").Connection;a.require=h;console.warn("twilio.js 1.1 is deprecated as of November 1, 2015. By January 1, 2016, twilio.js 1.1 will no longer be supported. Please update to twilio.js 1.2 or later. For more information, see <https://www.twilio.com/docs/api/client/twilio-js>. If you have any questions about this announcement, please contact Twilio Support at <help@twilio.com>.")};
var B="undefined"!=typeof B?B:function(){for(var h=window.location.protocol||"http:",a="//static.twilio.com/libs/twiliojs/1.0/",f=document.getElementsByTagName("script"),e=/(\w+:)?(\/\/.*)(twilio.min.js|twilio.js)/,d=0;d<f.length;d++){var c=f[d].src.match(e);if(c){h=c[1]||h;a=c[2];break}}return h+a}(),J=B+"WebSocket.swf";window&&(window.WEB_SOCKET_SWF_LOCATION=J);this.JSON||(JSON=function(){function h(a){return 10>a?"0"+a:a}function a(e,d){var c,g,b,k;c=/["\\\x00-\x1f\x7f-\x9f]/g;var h;switch(typeof e){case "string":return c.test(e)?
'"'+e.replace(c,function(a){var b=f[a];if(b)return b;b=a.charCodeAt();return"\\u00"+Math.floor(b/16).toString(16)+(b%16).toString(16)})+'"':'"'+e+'"';case "number":return isFinite(e)?String(e):"null";case "boolean":case "null":return String(e);case "object":if(!e)return"null";if("function"===typeof e.toJSON)return a(e.toJSON());c=[];if("number"===typeof e.length&&!e.propertyIsEnumerable("length")){k=e.length;for(g=0;g<k;g+=1)c.push(a(e[g],d)||"null");return"["+c.join(",")+"]"}if(d)for(k=d.length,
g=0;g<k;g+=1)b=d[g],"string"===typeof b&&(h=a(e[b],d))&&c.push(a(b)+":"+h);else for(b in e)"string"===typeof b&&(h=a(e[b],d))&&c.push(a(b)+":"+h);return"{"+c.join(",")+"}"}}Date.prototype.toJSON=function(){return this.getUTCFullYear()+"-"+h(this.getUTCMonth()+1)+"-"+h(this.getUTCDate())+"T"+h(this.getUTCHours())+":"+h(this.getUTCMinutes())+":"+h(this.getUTCSeconds())+"Z"};var f={"\b":"\\b","\t":"\\t","\n":"\\n","\f":"\\f","\r":"\\r",'"':'\\"',"\\":"\\\\"};return{stringify:a,parse:function(a,d){function c(a,
e){var g,f;if(e&&"object"===typeof e)for(g in e)Object.prototype.hasOwnProperty.apply(e,[g])&&(f=c(g,e[g]),void 0!==f&&(e[g]=f));return d(a,e)}var g;if(/^[\],:{}\s]*$/.test(a.replace(/\\./g,"@").replace(/"[^"\\\n\r]*"|true|false|null|-?\d+(?:\.\d*)?(?:[eE][+\-]?\d+)?/g,"]").replace(/(?:^|:|,)(?:\s*\[)+/g,"")))return g=eval("("+a+")"),"function"===typeof d?c("",g):g;throw new SyntaxError("parseJSON");}}}());var C=function(){function h(){if(!H){try{var a=n.getElementsByTagName("body")[0].appendChild(n.createElement("span"));
a.parentNode.removeChild(a)}catch(b){return}H=!0;for(var a=x.length,c=0;c<a;c++)x[c]()}}function a(a){H?a():x[x.length]=a}function f(a){if("undefined"!=typeof z.addEventListener)z.addEventListener("load",a,!1);else if("undefined"!=typeof n.addEventListener)n.addEventListener("load",a,!1);else if("undefined"!=typeof z.attachEvent)u(z,"onload",a);else if("function"==typeof z.onload){var b=z.onload;z.onload=function(){b();a()}}else z.onload=a}function e(){var a=n.getElementsByTagName("body")[0],b=n.createElement("object");
b.setAttribute("type","application/x-shockwave-flash");var c=a.appendChild(b);if(c){var e=0;(function(){if("undefined"!=typeof c.GetVariable){var g=c.GetVariable("$version");g&&(g=g.split(" ")[1].split(","),l.pv=[parseInt(g[0],10),parseInt(g[1],10),parseInt(g[2],10)])}else if(10>e){e++;setTimeout(arguments.callee,10);return}a.removeChild(b);c=null;d()})()}else d()}function d(){var a=F.length;if(0<a)for(var e=0;e<a;e++){var d=F[e].id,f=F[e].callbackFn,h={success:!1,id:d};if(0<l.pv[0]){var m=p(d);if(m)if(!w(F[e].swfVersion)||
l.wk&&312>l.wk)if(F[e].expressInstall&&g()){h={};h.data=F[e].expressInstall;h.width=m.getAttribute("width")||"0";h.height=m.getAttribute("height")||"0";m.getAttribute("class")&&(h.styleclass=m.getAttribute("class"));m.getAttribute("align")&&(h.align=m.getAttribute("align"));for(var q={},m=m.getElementsByTagName("param"),n=m.length,r=0;r<n;r++)"movie"!=m[r].getAttribute("name").toLowerCase()&&(q[m[r].getAttribute("name")]=m[r].getAttribute("value"));b(h,q,d,f)}else k(m),f&&f(h);else v(d,!0),f&&(h.success=
!0,h.ref=c(d),f(h))}else v(d,!0),f&&((d=c(d))&&"undefined"!=typeof d.SetVariable&&(h.success=!0,h.ref=d),f(h))}}function c(a){var b=null;(a=p(a))&&"OBJECT"==a.nodeName&&("undefined"!=typeof a.SetVariable?b=a:(a=a.getElementsByTagName("object")[0])&&(b=a));return b}function g(){return!N&&w("6.0.65")&&(l.win||l.mac)&&!(l.wk&&312>l.wk)}function b(a,b,c,e){N=!0;G=e||null;J={success:!1,id:c};var d=p(c);if(d){"OBJECT"==d.nodeName?(L=m(d),O=null):(L=d,O=c);a.id="SWFObjectExprInst";if("undefined"==typeof a.width||
!/%$/.test(a.width)&&310>parseInt(a.width,10))a.width="310";if("undefined"==typeof a.height||!/%$/.test(a.height)&&137>parseInt(a.height,10))a.height="137";n.title=n.title.slice(0,47)+" - Flash Player Installation";e=l.ie&&l.win?"ActiveX":"PlugIn";e="MMredirectURL="+z.location.toString().replace(/&/g,"%26")+"&MMplayerType="+e+"&MMdoctitle="+n.title;b.flashvars="undefined"!=typeof b.flashvars?b.flashvars+("&"+e):e;l.ie&&l.win&&4!=d.readyState&&(e=n.createElement("div"),c+="SWFObjectNew",e.setAttribute("id",
c),d.parentNode.insertBefore(e,d),d.style.display="none",function(){4==d.readyState?d.parentNode.removeChild(d):setTimeout(arguments.callee,10)}());q(a,b,c)}}function k(a){if(l.ie&&l.win&&4!=a.readyState){var b=n.createElement("div");a.parentNode.insertBefore(b,a);b.parentNode.replaceChild(m(a),b);a.style.display="none";(function(){4==a.readyState?a.parentNode.removeChild(a):setTimeout(arguments.callee,10)})()}else a.parentNode.replaceChild(m(a),a)}function m(a){var b=n.createElement("div");if(l.win&&
l.ie)b.innerHTML=a.innerHTML;else if(a=a.getElementsByTagName("object")[0])if(a=a.childNodes)for(var c=a.length,e=0;e<c;e++)1==a[e].nodeType&&"PARAM"==a[e].nodeName||8==a[e].nodeType||b.appendChild(a[e].cloneNode(!0));return b}function q(a,b,c){var e,d=p(c);if(l.wk&&312>l.wk)return e;if(d)if("undefined"==typeof a.id&&(a.id=c),l.ie&&l.win){var g="",f;for(f in a)a[f]!=Object.prototype[f]&&("data"==f.toLowerCase()?b.movie=a[f]:"styleclass"==f.toLowerCase()?g+=' class="'+a[f]+'"':"classid"!=f.toLowerCase()&&
(g+=" "+f+'="'+a[f]+'"'));f="";for(var k in b)b[k]!=Object.prototype[k]&&(f+='<param name="'+k+'" value="'+b[k]+'" />');d.outerHTML='<object classid="clsid:D27CDB6E-AE6D-11cf-96B8-444553540000"'+g+">"+f+"</object>";y[y.length]=a.id;e=p(a.id)}else{k=n.createElement("object");k.setAttribute("type","application/x-shockwave-flash");for(var h in a)a[h]!=Object.prototype[h]&&("styleclass"==h.toLowerCase()?k.setAttribute("class",a[h]):"classid"!=h.toLowerCase()&&k.setAttribute(h,a[h]));for(g in b)b[g]!=
Object.prototype[g]&&"movie"!=g.toLowerCase()&&(a=k,f=g,h=b[g],c=n.createElement("param"),c.setAttribute("name",f),c.setAttribute("value",h),a.appendChild(c));d.parentNode.replaceChild(k,d);e=k}return e}function t(a){var b=p(a);b&&"OBJECT"==b.nodeName&&(l.ie&&l.win?(b.style.display="none",function(){if(4==b.readyState){var c=p(a);if(c){for(var e in c)"function"==typeof c[e]&&(c[e]=null);c.parentNode.removeChild(c)}}else setTimeout(arguments.callee,10)}()):b.parentNode.removeChild(b))}function p(a){var b=
null;try{b=n.getElementById(a)}catch(c){}return b}function u(a,b,c){a.attachEvent(b,c);K[K.length]=[a,b,c]}function w(a){var b=l.pv;a=a.split(".");a[0]=parseInt(a[0],10);a[1]=parseInt(a[1],10)||0;a[2]=parseInt(a[2],10)||0;return b[0]>a[0]||b[0]==a[0]&&b[1]>a[1]||b[0]==a[0]&&b[1]==a[1]&&b[2]>=a[2]?!0:!1}function r(a,b,c,e){if(!l.ie||!l.mac){var d=n.getElementsByTagName("head")[0];d&&(c=c&&"string"==typeof c?c:"screen",e&&(P=D=null),D&&P==c||(e=n.createElement("style"),e.setAttribute("type","text/css"),
e.setAttribute("media",c),D=d.appendChild(e),l.ie&&l.win&&"undefined"!=typeof n.styleSheets&&0<n.styleSheets.length&&(D=n.styleSheets[n.styleSheets.length-1]),P=c),l.ie&&l.win?D&&"object"==typeof D.addRule&&D.addRule(a,b):D&&"undefined"!=typeof n.createTextNode&&D.appendChild(n.createTextNode(a+" {"+b+"}")))}}function v(a,b){if(M){var c=b?"visible":"hidden";H&&p(a)?p(a).style.visibility=c:r("#"+a,"visibility:"+c)}}function A(a){return null!=/[\\\"<>\.;]/.exec(a)&&"undefined"!=typeof encodeURIComponent?
encodeURIComponent(a):a}var z=window,n=document,E=navigator,B=!1,x=[function(){B?e():d()}],F=[],y=[],K=[],L,O,G,J,H=!1,N=!1,D,P,M=!0,l=function(){var a="undefined"!=typeof n.getElementById&&"undefined"!=typeof n.getElementsByTagName&&"undefined"!=typeof n.createElement,b=E.userAgent.toLowerCase(),c=E.platform.toLowerCase(),e=c?/win/.test(c):/win/.test(b),c=c?/mac/.test(c):/mac/.test(b),b=/webkit/.test(b)?parseFloat(b.replace(/^.*webkit\/(\d+(\.\d+)?).*$/,"$1")):!1,d=!+"\v1",g=[0,0,0],f=null;if("undefined"!=
typeof E.plugins&&"object"==typeof E.plugins["Shockwave Flash"])!(f=E.plugins["Shockwave Flash"].description)||"undefined"!=typeof E.mimeTypes&&E.mimeTypes["application/x-shockwave-flash"]&&!E.mimeTypes["application/x-shockwave-flash"].enabledPlugin||(B=!0,d=!1,f=f.replace(/^.*\s+(\S+\s+\S+$)/,"$1"),g[0]=parseInt(f.replace(/^(.*)\..*$/,"$1"),10),g[1]=parseInt(f.replace(/^.*\.(.*)\s.*$/,"$1"),10),g[2]=/[a-zA-Z]/.test(f)?parseInt(f.replace(/^.*[a-zA-Z]+(.*)$/,"$1"),10):0);else if("undefined"!=typeof z.ActiveXObject)try{var k=
